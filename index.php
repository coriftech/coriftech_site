			...
			<div id="rev_slider_1" class="rev_slider fullwidthabanner" data-version="5.4.5" style="display:none">
				<ul>
					...
					<li data-transition="slidingoverlayhorizontal">
                        <video src="images/banner-user-onboarding.mp4" autoplay loop muted class="rev-slidebg"></video>
					    ...
					    >Welcome to the Coriftech Solutions LTD</h2>
    					...
    					data-responsive_offset="off"
					    >
						    <a href="services" class="btn1 flex-c-c">
						    	Our Services
						    </a>

						    <a href="about" class="btn2 flex-c-c">
						    	Learn more
						    </a>
					    </div>
					</li>
					...
					<li data-transition="slidingoverlayvertical">
						<img src="images/banner-domain-search.jpg" alt="IMG-SLIDE" class="rev-slidebg">
    					...
    					data-responsive_offset="off"
					    >
                            Nigerian based Information Technology Consultancy Company
                        </p>
